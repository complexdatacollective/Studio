...
export const selectTriggerStyles = cn(
  'text-input-foreground bg-input rounded-xl flex h-10 w-full items-center justify-between border border-border px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50',
